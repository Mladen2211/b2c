<template>
    <div class="d-flex justify-space-between align-center py-3 primary-font">
        <div class="d-flex">
            <v-img width="86" height="55" :src="treatment.imgUrl"></v-img>
            <div class="pl-2">
                <span >{{treatment.treatmentName}}</span><br>
                <span class="font-weight-light">{{treatment.salon}}</span>
            </div>
        </div>
        <div>
